...
export default function AppleMenu({
  ...
  return (
    <div
      className="fixed top-6 left-4 w-56 bg-gray-100 bg-opacity-80 blur border-b border-l border-r border-gray-400 border-opacity-50 rounded-b-lg shadow-2xl"
    ...
    >
      ...
      <MenuItemGroup border={false}>
        ...
        <MenuItem onClick={logout}>Log Out Glanfaloth Cevnas...</MenuItem>
      </MenuItemGroup>
    </div>
  );
}
