...
const TopBar = (props: TopBarProps) => {
  ...
  const { volume, wifi, bluetooth } = useSelector((state: RootReduxState) => ({
    volume: state.volume,
    wifi: state.wifi,
  ...
  const toggleBlueToothMenu = (): void => {
    setState({
      ...state,
      showBlueToothMenu: !state.showBlueToothMenu
    });
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-end items-center space-x-2">
        ...
        {state.showBlueToothMenu && (
          <BlueToothMenu
            toggleBlueToothMenu={toggleBlueToothMenu}
            btnRef={blueToothBtnRef}
          />
        )}
